package com.lkhpractice.board.service;
...
import com.lkhpractice.board.exception.DataNotFoundException;
import com.lkhpractice.board.repository.AnswerRepository;
...
public class AnswerService {
	...
	public Answer getAnswer(Integer id) {
		...
		if(optAnswer.isPresent()) {
			return optAnswer.get(); // answer 객체
		} else {
